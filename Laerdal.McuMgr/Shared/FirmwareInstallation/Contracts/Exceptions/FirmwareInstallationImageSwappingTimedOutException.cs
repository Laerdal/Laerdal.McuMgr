...
namespace Laerdal.McuMgr.FirmwareInstallation.Contracts.Exceptions
{
    ...
    {
        public FirmwareInstallationImageSwappingTimedOutException(int? estimatedSwapTimeInMilliseconds, EFirmwareInstallerFatalErrorType fatalErrorType, EGlobalErrorCode globalErrorCode)
            : base(
