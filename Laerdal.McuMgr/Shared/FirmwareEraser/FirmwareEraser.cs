    ...
    public partial class FirmwareEraser : IFirmwareEraser, IFirmwareEraserEventEmitters
    {
        ...
        public async Task EraseAsync(int imageIndex = 1, int timeoutInMs = -1)
        {
            ...
            try
            {
                ...
                BeginErasure(imageIndex); //00 dont use task.run here
            ...
            //    taskcompletionsource right after    but we would also have to account for exceptions thus complicating the code considerably
            //    for little to no practical gain
            //
