...
namespace Laerdal.McuMgr.FileUploading.Contracts
{
    public interface IFileUploaderEventSubscribable
    {
        ...
        /// <summary>Event raised when the operation gets paused</summary>
        event EventHandler<FileUploadPausedEventArgs> FileUploadPaused;
        
        /// <summary>Event raised when the operation gets resumed</summary>
        event EventHandler<FileUploadResumedEventArgs> FileUploadResumed;

        /// <summary>Event raised when the file-uploading actually starts</summary>
        event EventHandler<FileUploadStartedEventArgs> FileUploadStarted;

        /// <summary>Event raised when the file-uploading completes successfully</summary>
        event EventHandler<FileUploadCompletedEventArgs> FileUploadCompleted;
