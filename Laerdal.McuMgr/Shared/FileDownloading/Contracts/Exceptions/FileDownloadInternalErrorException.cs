...
namespace Laerdal.McuMgr.FileDownloading.Contracts.Exceptions
{
    ...
    public class FileDownloadInternalErrorException : FileDownloadErroredOutException, IDownloadException
    {
        public FileDownloadInternalErrorException(string message = "(no details)", Exception innerException = null)
