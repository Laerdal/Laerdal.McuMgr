...
public class FirmwareEraserShould
{
    ...
    {
        // Arrange
        var mockedNativeFirmwareEraserProxy = new MockedGreenNativeFirmwareEraserProxy(new FirmwareEraser.FirmwareEraser.GenericNativeFirmwareEraserCallbacksProxy());
        var firmwareEraser = new FirmwareEraser.FirmwareEraser(mockedNativeFirmwareEraserProxy);
        
        // Act
        var work = () => firmwareEraser.EraseAsync(imageIndex: 2);

        // Assert
        await work.Should().CompleteWithinAsync(150.Milliseconds());
    ...
    {
        // Arrange
        var mockedNativeFirmwareEraserProxy = new MockedErroneousNativeFirmwareEraserProxy(new FirmwareEraser.FirmwareEraser.GenericNativeFirmwareEraserCallbacksProxy());
        var firmwareEraser = new FirmwareEraser.FirmwareEraser(mockedNativeFirmwareEraserProxy);
