        ...
        private class MockedGreenNativeFileUploaderProxySpy60 : BaseMockedNativeFileUploaderProxySpy
        {
            ...
            )
            {
                ...
                Task.Run(async () => //00 vital
                {
                    ...
                    {
                        NativePauseGuardDuringUploadingPhaseSlim.Wait(); await Task.Delay(005); FileUploadProgressPercentageAndDataThroughputChangedAdvertisement(resourceId:resourceId, remoteFilePath:remoteFilePath, progressPercentage:00, currentThroughputInKBps:00, totalAverageThroughputInKBps:00);
                        NativePauseGuardDuringUploadingPhaseSlim.Wait(); await Task.Delay(005); FileUploadProgressPercentageAndDataThroughputChangedAdvertisement(resourceId:resourceId, remoteFilePath:remoteFilePath, progressPercentage:10, currentThroughputInKBps:10, totalAverageThroughputInKBps:10);
                        NativePauseGuardDuringUploadingPhaseSlim.Wait(); await Task.Delay(005); FileUploadProgressPercentageAndDataThroughputChangedAdvertisement(resourceId:resourceId, remoteFilePath:remoteFilePath, progressPercentage:20, currentThroughputInKBps:10, totalAverageThroughputInKBps:10);
                        NativePauseGuardDuringUploadingPhaseSlim.Wait(); await Task.Delay(005); FileUploadProgressPercentageAndDataThroughputChangedAdvertisement(resourceId:resourceId, remoteFilePath:remoteFilePath, progressPercentage:30, currentThroughputInKBps:10, totalAverageThroughputInKBps:10);
                        NativePauseGuardDuringUploadingPhaseSlim.Wait(); await Task.Delay(005); FileUploadProgressPercentageAndDataThroughputChangedAdvertisement(resourceId:resourceId, remoteFilePath:remoteFilePath, progressPercentage:40, currentThroughputInKBps:10, totalAverageThroughputInKBps:10);
                        NativePauseGuardDuringUploadingPhaseSlim.Wait(); await Task.Delay(005); FileUploadProgressPercentageAndDataThroughputChangedAdvertisement(resourceId:resourceId, remoteFilePath:remoteFilePath, progressPercentage:50, currentThroughputInKBps:10, totalAverageThroughputInKBps:10);
                        NativePauseGuardDuringUploadingPhaseSlim.Wait(); await Task.Delay(005); FileUploadProgressPercentageAndDataThroughputChangedAdvertisement(resourceId:resourceId, remoteFilePath:remoteFilePath, progressPercentage:60, currentThroughputInKBps:10, totalAverageThroughputInKBps:10);
                        NativePauseGuardDuringUploadingPhaseSlim.Wait(); await Task.Delay(005); FileUploadProgressPercentageAndDataThroughputChangedAdvertisement(resourceId:resourceId, remoteFilePath:remoteFilePath, progressPercentage:70, currentThroughputInKBps:10, totalAverageThroughputInKBps:10);
                        NativePauseGuardDuringUploadingPhaseSlim.Wait(); await Task.Delay(005); FileUploadProgressPercentageAndDataThroughputChangedAdvertisement(resourceId:resourceId, remoteFilePath:remoteFilePath, progressPercentage:80, currentThroughputInKBps:10, totalAverageThroughputInKBps:10);
                        NativePauseGuardDuringUploadingPhaseSlim.Wait(); await Task.Delay(005); FileUploadProgressPercentageAndDataThroughputChangedAdvertisement(resourceId:resourceId, remoteFilePath:remoteFilePath, progressPercentage:90, currentThroughputInKBps:10, totalAverageThroughputInKBps:10);
                        NativePauseGuardDuringUploadingPhaseSlim.Wait(); await Task.Delay(005); FileUploadProgressPercentageAndDataThroughputChangedAdvertisement(resourceId:resourceId, remoteFilePath:remoteFilePath, progressPercentage:100, currentThroughputInKBps:10, totalAverageThroughputInKBps:10);
